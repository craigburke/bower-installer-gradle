...
If you set the bowerDebug property when you run *bowerInstall* then you'll get more detailed outpute and both the `bower.json` file and the `bower_components` folder will remain to help troubleshoot.
